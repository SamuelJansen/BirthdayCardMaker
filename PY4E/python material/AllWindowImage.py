...
import pygame as pg
        ...
        ###- label = tk.Label(self.Frame, text="test").bind('<Button-3>', self.exit).pack()
        """
        title =
        label = tk.Label(self,text=message,background=bg,foreground='white',font='Fonts/good_times_rg.ttf 22 bold')
        label.pack()
        self.Frame.pack()
        """
